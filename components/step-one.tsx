...
export default function StepOne({ formData, onUpdateFormData }: StepProps) {
  ...
  const handleAddressSearch = (inputValue: string) => {
    ...
    // Clear stored address when user edits the input
    if (formData.address) {
      onUpdateFormData("address", "")
      onUpdateFormData("street", "")
      onUpdateFormData("city", "")
      onUpdateFormData("state", "")
      onUpdateFormData("zipcode", "")
      onUpdateFormData("latitude", "")
      onUpdateFormData("longitude", "")
      if (marker) {
        marker.setMap(null)
        setMarker(null)
      }
