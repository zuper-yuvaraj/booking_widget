  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <MapPin className="mx-auto w-12 h-12 mb-4 text-[#3170c7]" />
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-3 border-2 border-[#3170c7] rounded-lg shadow-sm focus:ring-2 focus:ring-[#3170c7] focus:border-[#3170c7] text-lg"
          disabled={!isLoaded}
        />
          ...
          <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
            {predictions.map((prediction) => (
              <div
                ...
                className="px-4 py-3 cursor-pointer border-b last:border-b-0 border-gray-100 hover:bg-[#3170c7]/10 transition-colors"
              >
      ...
      {formData.address && (
        <div className="p-4 bg-[#3170c7]/10 border border-[#3170c7] rounded-lg">
          <p className="text-sm text-[#3170c7]">
