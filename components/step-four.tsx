...
export default function StepFour({ formData, onUpdateFormData }: StepProps) {
  ...
  for (let i = 0; i < 30; i++) {
    ...
    dates.push(d) // ✅ do NOT skip Sundays
  }
  ...
  const allDates = generateOneMonthDates()
        ...
        <div className="border border-gray-200 rounded-lg p-4">
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <span className="text-sm text-gray-600">
              By submitting your phone number, you agree to receive marketing text messages from SunElevated. Message frequency varies. Message and data rates may apply.{" "}
              <span className="text-blue-600">Text HELP for Support.</span> <span className="text-blue-600">Text STOP to opt-out.</span> View our{" "}
