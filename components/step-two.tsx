      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => onUpdateFormData("services", e.target.value)}
            onKeyDown={handleKeyPress}
            required
          ...
          >
            ...
            <option value="Shingled roofs">Shingled roofs</option>
            <option value="Commercial flat roof">Commercial flat roof</option>
        ...
        <div className="mt-6">
          <div className="flex items-start space-x-3">
            ...
            >
              ...
              marketing text messages from {COMPANY_NAME}. Message
              frequency varies. Message and data rates may apply.
              Text HELP for Support. Text STOP to opt-out. View our{" "}
              <a
                href={PRIVACY_POLICY}
                target="_blank"
