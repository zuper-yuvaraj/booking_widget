      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              onUpdateFormData("job_description", e.target.value)
            }
            rows={4}
            ...
            onKeyDown={(e) => {
              // Prevent Enter from triggering next step
              e.stopPropagation()
            }}
          />
        </div>
        ...
        <div className="mt-6">
          <div className="flex items-start space-x-3">
            ...
            >
              ...
              text messages from {COMPANY_NAME}. Message frequency varies.
              Message and data rates may apply. Text HELP for Support. Text STOP
              to opt-out. Please review our{" "}
              <a
