  ...
  return (
    <div className="max-w-md mx-auto space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="booking-description">
            Description
          </label>
          <textarea
            ...
            rows={4}
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 resize-y min-h-[100px]"
            placeholder="Add issue details we should know"
          />
        </div>
